...
const ru: PartialLocaleType = {
 ...
 `,
  ...
  Auth: {
    ...
    TopTips:
      "🥳 Предложение по запуску chatbox-dp AI: разблокируйте OpenAI o1, GPT-4o, Claude-3.5 и новейшие большие модели прямо сейчас",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Используйте chatbox-dp AI",
        Label: "(Самое экономичное решение)",
        SubTitle:
          "Официально поддерживается chatbox-dp, готов к использованию без настройки, поддерживает последние крупные модели, такие как OpenAI o1, GPT-4o и Claude-3.5",
        ChatNow: "Начать чат",
      },
